...
docker tag qvm-tests docker.lab.rigetti.com/qcs/qvm-tests:$bamboo_DOCKER_IMAGE_TAG
docker push docker.lab.rigetti.com/qcs/qvm-tests:$bamboo_DOCKER_IMAGE_TAG
