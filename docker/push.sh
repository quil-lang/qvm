...
then
    ...
    docker tag qvm docker.lab.rigetti.com/qcs/qvm:$STABLE
    docker push docker.lab.rigetti.com/qcs/qvm:$STABLE
...
docker tag qvm docker.lab.rigetti.com/qcs/qvm:$bamboo_DOCKER_IMAGE_TAG
docker push docker.lab.rigetti.com/qcs/qvm:$bamboo_DOCKER_IMAGE_TAG
