...
(defun make-test-channel-qvm ()
  (let* ((p1 (make-noise-pred (match-any-n-qubits (list 0 1) 1) 1 "after"))
...
(defun test-channel-noise-model ()
  (let* ((pred1 (make-noise-pred (match-strict-qubits (list 0 1)) 1 "after"))
          (pred2 (make-noise-pred (match-strict-gates (list "X" "Z")) 1 "after"))
